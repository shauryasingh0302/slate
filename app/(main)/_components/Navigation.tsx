...
import { userSetting } from "@/hooks/useSettings";
        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    onClick={resetWidth}
                    className="opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize absolute h-full w-1 bg-primary/13 right-0 top-0"
                />
            </aside>
